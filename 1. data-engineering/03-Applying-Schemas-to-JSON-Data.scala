...
// MAGIC
// MAGIC Import data from `/mnt/training/UbiqLog4UCI/14_F/log*`. (This is the log files from a given user.)
...
// MAGIC ## Next Steps
// MAGIC
// MAGIC Start the next lesson, [Loading Data and Productionizing]($./05-Loading-Data-and-Productionalizing ).
