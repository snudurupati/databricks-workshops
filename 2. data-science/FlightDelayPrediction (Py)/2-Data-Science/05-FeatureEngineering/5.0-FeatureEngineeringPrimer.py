...
# MAGIC %md In our exercise, the features of relevance/importance have been determined ahead of time.  So, we will focus on cleaning up these attributes in preparation of modeling.
# MAGIC
# MAGIC https://machinelearningmastery.com/
